...
export const DeveloperCard = () => {
  ...
  const specialties = [
    { name: 'MCP协议开发', icon: Zap, description: 'Model Context Protocol相关开发', level: '熟悉' },
    { name: 'RAG系统构建', icon: Brain, description: '检索增强生成系统的设计与实现', level: '熟悉' },
    { name: 'AI大模型开发', icon: Code, description: 'AI大模型相关开发', level: '熟悉' },
    { name: '模型微调', icon: Target, description: '针对特定任务的模型优化', level: '熟悉' },
    { name: 'PyQt开发', icon: Monitor, description: '桌面应用程序开发', level: '熟悉' },
    { name: '全栈开发', icon: Coffee, description: '前后端全栈开发', level: '熟悉' },
  ];
  ...
  return (
    <div className="relative">
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogTrigger asChild>
          ...
          >
            <Avatar className="w-full h-full">
              <AvatarImage src="/mark.jpg" alt="Developer" />
        ...
        <DialogContent className="min-w-[750px] max-h-[90vh] overflow-hidden bg-white border-0 shadow-2xl">
                        ...
                        {contactMethods.map((contact, index) => {
                          ...
                          return (
                            <div key={index} className="icon-content">
                              ...
                              >
                                <div className="filled" style={{ backgroundColor: contact.color }}></div>
                              ...
                              <div className="mt-2 text-center">
                                <div className="text-xs font-medium text-gray-500">{contact.label}</div>
                              </div>
                            </div>
                          );
                        })}
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-gray-600 hover:text-gray-800 hover:underline flex items-center gap-1 mt-1"
                            >
                              github.com/markcxx
                              <ExternalLink className="h-3 w-3" />
                            </a>
